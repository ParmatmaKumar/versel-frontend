...
function Navbar() {
  ...
  return (
    <div
      className={`flex h-14 items-center justify-center border-b border-b-gray-700 ${location.pathname !== "/" ? "bg-gray-800" : ""
    ...
    >
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
        ...
        <div className="hidden items-center gap-x-4 md:flex">
          ...
          {token === null && (
            <Link to="/login">
              <button className="rounded-lg border border-gray-700 bg-richblack-800 px-3 py-2 text-gray-100">
                Log in
              </button>
            </Link>
          )}
