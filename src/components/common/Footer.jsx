...
const Footer = () => {
  return (
    <div className="bg-gray-900">
      <div className="flex lg:flex-row gap-8 items-center justify-between w-[1260px] max-w-maxContent text-gray-400 leading-6 mx-auto relative py-14">
        <div className="border-b w-full flex flex-col lg:flex-row pb-5 border-gray-900">
          {/* Section 1 */}
